...
Thanks for looking under the hood. Mr. AutoDuck is small on purpose; good contributions keep it that way.
...
```sh
Scripts/build-app.sh --run      # SwiftPM release build → "build/Mr. AutoDuck.app", launched
...
- Contributions are accepted under the GPLv3, same as the project. The Mr. AutoDuck name and mascot are
